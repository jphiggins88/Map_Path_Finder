...
This project demonstrates using the A* search algorithm to find a route from a specified starting point to a specified ending point.
This project relies on the IO2D rendering library.
This project was completely rebuilt from an original project done for a Udacity course.

## Cloning

git clone <this git URL> --recurse-submodules
...
// I've added "target_compile_options(run PUBLIC -g)" to CmakeList.txt so the code will compile with the debug symbols.